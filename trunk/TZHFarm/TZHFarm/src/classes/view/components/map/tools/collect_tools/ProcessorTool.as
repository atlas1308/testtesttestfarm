package classes.view.components.map.tools.collect_tools {
    ...
    public class ProcessorTool extends Subtool {
        ...
        protected var wait_message:String = ResourceManager.getInstance().getString("message","wait_message");
        ...
        protected function show_timer():void{
            ...
            msg = (msg + (((eater.product_name() + ": ") + eater.product_percent()) + ResourceManager.getInstance().getString("message","percent_ready_message")));
            tip(msg);
        }
            ...
            if (eater){
                ...
                if (can_collect()){
                    ...
                    if (can_refill()){
                        ...
                        error_message = ResourceManager.getInstance().getString("message","error_message_full_message",[eater.get_name()])
                        confirm();
                    }
                }
            }
