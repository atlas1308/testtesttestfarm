 ...
 * @package    Ko
 * @author     Ko Team, Eric 
 * @version    $Id: request.php 94 2010-07-04 16:05:33Z eric $ request.php 36 2009-09-22 08:27:32Z eric $
...
class Request
{
    ...
    public function execute ()
    {
        try {
            ...
            $class = new ReflectionClass(ucfirst($this->controller) . 'Controller');
            if ($class->isAbstract()) {
        ...
        try {
            ...
            // Use __call instead
            $class->getMethod('__call')->invokeArgs($controller, array($this->getMethod() , $this->_params));
        }
        return $this;
    }
