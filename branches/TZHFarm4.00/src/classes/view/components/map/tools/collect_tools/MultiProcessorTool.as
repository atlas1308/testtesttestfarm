package classes.view.components.map.tools.collect_tools {
    ...
    public class MultiProcessorTool extends Subtool {
        ...
        protected var switch_message:String = ResourceManager.getInstance().getString("message","click_to_select_message");
        protected var interval:Number;
        protected var refill_material:Number;
        protected var collect_message:String = ResourceManager.getInstance().getString("message","click_to_collect_message");
        protected var refill_message:String = ResourceManager.getInstance().getString("message","click_to_refill_message");
        ...
        protected function show_timer():void{
            ...
            msg = (msg + (((multi_processor.product_name() + ": ") + multi_processor.product_percent()) + ResourceManager.getInstance().getString("message","percent_ready_message")));
            tip(msg);
        }
