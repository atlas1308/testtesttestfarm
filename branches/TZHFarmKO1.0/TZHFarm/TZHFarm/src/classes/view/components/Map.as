package classes.view.components {
    ...
    public class Map extends Sprite {
        ...
        public const ADD_PLANT:String = "addPlant";
        public const ADD_MAP_OBJECT:String = "addMapObject";
        public const PROCESS_COMPLETE:String = "processComplete";
        public const REMOVE_MAP_OBJECT:String = "removeMapObject";
        public const REFILL_MAP_OBJECT:String = "refillMapObject";
        public const MAP_OBJECTS_UPDATED:String = "mapObjectsUpdated";
        public const ON_POLLINATE:String = "onPollinate";
        public const SHOW_SHOP_AND_ADD_PLANT:String = "showShopAndAddPlant";
        public const AUTO_COLLECT:String = "autoCollect";
        public const FERTILIZE:String = "fertilize";
        public const ADD_ANIMAL:String = "addAnimal";
        ...
        public const AUTO_REFILL:String = "autoRefill";
        public const MOVE_MAP_OBJECT:String = "moveMapObject";
        public const SHOW_CHRISTMAS_PRESENTS:String = "showChristmasPresents";
        public const SELECT_RAW_MATERIAL:String = "selectRawMaterial";
        public const TOGGLE_AUTOMATION:String = "toggleAutomation";
        public const FEED_MAP_OBJECT:String = "feedMapObject";
        public const APPLY_RAIN:String = "applyRain";
        ...
        private function object_compare(obj_A:Object, obj_B:Object):Number{
            ...
            if ((((a_x < (b_x + b_w))) && ((a_y < b_y)))){// a 在 b 的左下方
                return (-1);
            };
            if (((((a_y + a_h) > b_y)) && ((a_x >= (b_x + b_w))))){// a 在 b的上方
                return (1);
            };
            if (((((a_x + a_w) > b_x)) && ((a_y >= (b_y + b_h))))){// 右上 a 在 b 的右上
                return (1);
            };
            return (0);
        }
