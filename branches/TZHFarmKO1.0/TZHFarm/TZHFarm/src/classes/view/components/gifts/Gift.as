...
package classes.view.components.gifts {
    ...
    public class Gift extends Sprite {
        ...
        private function imageLoaded(e:Event):void{
            var img:Bitmap = (e.target.asset as Bitmap);
            img.x = (-(img.width) / 2);
            image.addChild(img);
            image.x = (qty.x / 2);
        ...
        private function init():void{
            ...
            use_btn.set_fixed_width(50);
            trade_btn = new GameButton(ResourceManager.getInstance().getString("message","game_button_trade_message"), 13, (15 / 13));
            trade_btn.set_fixed_width(50);
            addChild(use_btn);
            //addChild(trade_btn);//hide trade
            // button information added by pangfei
            use_btn.y = (this.skin.height - (use_btn.height / 2))-12;
            //trade_btn.y = (this.skin.height - (trade_btn.height / 2))-12;
            if (!data.trade_for){
                ...
                use_btn.x = dw;
//                trade_btn.x = ((use_btn.x + use_btn.width) + dw);
            };
        ...
        public function kill():void{
            cache.removeEventListener(Cache.LOAD_COMPLETE, imageLoaded);
