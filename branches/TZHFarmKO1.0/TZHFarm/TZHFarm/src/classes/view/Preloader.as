package classes.view
{
	...
	public class Preloader extends MovieClip
	{
		...
		public function Preloader()
		{
			...
			var ww:Number = rect.width >> 1;
			var hh:Number = rect.height >> 1;
			this.loading.x = Math.floor(this.stage.stageWidth - ww);
			this.loading.y = Math.floor(this.stage.stageHeight - hh);
