		...
		switch ($method) {
			...
			case 'test_map':
				...
				array(
		                ...
		                'map_x'     => 101,
		                'map_y'     => 101,
		                'flipped'   => isset($map['flipped']) ? $map['flipped'] : 0,
					    'obtained_materials'     => 3,
					    'automatic'     => 1,
					 	'times_used'     => 5,
					
		                'raw_materials' => isset($map['raw_materials']) ? $map['raw_materials'] : 0,
		                'pollinated'    => isset($map['pollinated']) ? $map['pollinated'] : 0,
		                'start_time'    => isset($map['start_time']) ? $map['start_time'] : 0
				)
				);
				return "===testmap=====";
				break;
