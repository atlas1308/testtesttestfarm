        ...
        override public function execute(value:INotification) : void
        {
            ...
            switch(value.getName())
            {
                ...
                case ApplicationFacade.SPEND_RP:
                {
                    ...
                    transactionBody = new SpendRPCall(size, target);
                    result = app_data.spend_rp(size, target);
                    break;
                }
                ...
                case ApplicationFacade.USE_GIFT:
                {
                    ...
                    transactionBody = new UseGiftCall(size, target);
                    result = app_data.use_gift(size, target);
                    break;
                }
                ...
                {
                    transactionBody = new SellItemCall(value.getBody() as Number);
