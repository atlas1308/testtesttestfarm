package classes.view.components.map {
    ...
    public class MultiProcessor extends CollectObject implements IProcessor {
        ...
        public function MultiProcessor(data:Object){
            raw_material = (data.raw_material as Array);
            product = (data.product as Array);
            product_names = data.product_names;
            raw_material_names = data.raw_material_names;
            raw_materials = ((data.raw_materials as Array)) ? data.raw_materials : new Array();
            products = ((data.products as Array)) ? data.products : new Array();
            selected_raw_material = (data.selected_raw_material) ? data.selected_raw_material : 0;
            var i:Number = 0;
        ...
        protected function produce():void{
            if (((has_all_raw_materials()) && ((products.length < max_products)))){
