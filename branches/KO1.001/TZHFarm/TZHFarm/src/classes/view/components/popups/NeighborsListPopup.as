package classes.view.components.popups
{
    ...
    public class NeighborsListPopup extends ComplexPopup
    {
        ...
        public function NeighborsListPopup(param1:Object)
        {
            super("Neighbors List", param1.list, 680, 470, 515, 300);
        }
        ...
        private function nextClicked(event:MouseEvent) : void
        {
            if (!last_selected)
            {
                popup = new DynamicPopup(380, 260, 300, 160, ResourceManager.getInstance().getString("message","neighbors_list_popup_message"));
