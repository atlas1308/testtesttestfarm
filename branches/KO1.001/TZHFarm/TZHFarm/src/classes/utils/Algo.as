package classes.utils {
    ...
    public dynamic class Algo {
        ...
        public static function time():Number{
            return (((new Date().time / 1000) - Algo.time_delay));
        }
        ...
        public static function set_time(value:Number):void{
            Algo.time_delay = ((new Date().time / 1000) - value);// 当前的时间和服务器返回的时间,算出一个具体的延迟
        }
        ...
        public static function enumerate(l:Array, d1:String=", ", d2:String=" and "):String{
            if (!l.length){
                return ("");
            };
