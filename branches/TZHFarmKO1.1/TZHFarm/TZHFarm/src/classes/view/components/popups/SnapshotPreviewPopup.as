// this class realizes the function to preview picture which is taken by the player. 
package classes.view.components.popups
{
    ...
    public class SnapshotPreviewPopup extends DynamicPopup
    {
        ...
        public function SnapshotPreviewPopup(param1:Bitmap) : void
        {
            this.bmp = param1;
        ...
        override protected function init() : void
        {
            ...
            var locTextFormat:* = new TextFormat();
