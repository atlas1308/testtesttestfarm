package classes.model
{
    ...
    public class Transaction extends EventDispatcher
    {
        ...
        private function test(evt:ProgressEvent):void {
    		trace("byteTotal :" + evt.bytesTotal);
    		trace("byteLoaded :" + evt.bytesLoaded);    
        }
        ...
        {
            Log.add("on result " + body.swf_version + " " + body.data_hash + " " + body.blocked);
            timer.reset();
        ...
        {
            trace("transaction onNetworkDelay", network_delay_timer.repeatCount);
